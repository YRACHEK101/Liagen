...
const CampagnesMarketing = () => {
  return (
    <section className="relative bg-deepSlate -mt-10 pt-20 after:absolute after:w-1/4 after:h-1/4 after:bg-[url('/images/wework/vector.svg')] after:top-10 after:right-0 after:bg-no-repeat">
